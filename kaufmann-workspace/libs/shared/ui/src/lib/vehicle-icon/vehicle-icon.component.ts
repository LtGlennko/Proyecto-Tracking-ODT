  ...
  template: `
    <span [class]="sizeClass()" [attr.title]="lineaNegocio()">
      <ng-container [ngSwitch]="iconKey()">
        <!-- Camión / VC -->
        <svg *ngSwitchCase="'truck'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Bus -->
        <svg *ngSwitchCase="'bus'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Auto -->
        <svg *ngSwitchCase="'car'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M5 17H3a2 2 0 01-2-2V9a2 2 0 012-2h2l2-4h8l2 4h2a2 2 0 012 2v6a2 2 0 01-2 2h-2"/>
          <circle cx="7" cy="17" r="2"/>
          <circle cx="17" cy="17" r="2"/>
        </svg>
        <!-- Maquinaria -->
        <svg *ngSwitchCase="'construction'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Default -->
        <svg *ngSwitchDefault viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
